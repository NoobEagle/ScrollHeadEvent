 ...
 * 修改历史:<br/>
 */
public class MyIndexView extends HorizontalScrollView {
     ...
     * @param attrs
     */
    public MyIndexView(Context context, AttributeSet attrs) {
     ...
     * @param defStyle
     */
    public MyIndexView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        // 获取我们定义的属性
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.MyIndexView, defStyle, 0);

        int n = a.getIndexCount();
        for (int i = 0; i < n; i++) {
            int attr = a.getIndex(i);
            switch (attr) {
                case R.styleable.MyIndexView_rightMenuPaddingLeft:
                    // dp to px
                    ...
                    break;
                case R.styleable.MyIndexView_leftMenuPaddingRight:
                    // dp to px
